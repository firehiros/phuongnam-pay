              ...
              <div id="flow_1">
                <div id="about_inner">
                  <div className="about1">
                    <h3>運営会社</h3>
                    <p>
                    Rays Walletは、VERTEX RAISE LIMITED社によって立ち上げられた新たなEウォレットブランドです。世界の基軸通貨に対応し、それぞれの地域におけるローカライズされたウォレットを目指していきます。さらにスピーディなアカウント開設に入出金、お支払い（決済）及び、国境の壁を超えた送金に対応いたします。「手数料が安く・スピーディな決済」をモットーにグローバルな範囲でご利用頂けるサービスをご提供いたします。
                    </p>
                  </div>
