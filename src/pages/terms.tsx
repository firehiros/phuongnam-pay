              ...
              <div id="flow_inner">
                <div id="flow_left">
                  <div className="terms_box">
                    ...
                    <ol>
                      <li>
                        8.1 本規約を遵守した場合、フィアット交換および暗号通貨交換に関連するサービスを提供する本サイトにアクセスする限定的な権利が付与されます。本サイトにアクセスる権利は、非独占的、譲渡不能、取消可能、限定的であり、制限と義務に従うものとします。本規約のいかなる条項も、本サイトまたは本サービスのライセンス（本項に定めるものを除く）、権利、タイトル、または所有権をお客様に与えるものではありません。
                      </li>
                      <li>
